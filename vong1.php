    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" align="center">
                <h1 style="color: white">VÒNG SUNG SỨC (x 1)</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="answer">
                    <div class="text">Diễn viên/ Ca sỹ/ Người nổi tiếng</div>
            ...
            <div class="col-md-6">
                ...
                <div class="answer">
                    <div class="text">Thể dục/ Thể hình</div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="answer">
                    <div class="text">Phòng tập đắt tiền/ sang trọng</div>
        ...
        <div class="row">
            <div class="col-md-6" style="margin-left: 0;">
                ...
                <div class="answer">
                    <div class="text">Thế giới thứ 3</div>
                    <div class="point">6</div>
                </div>
            </div>
            <div class="col-md-6 score">Score: <span>0</span></div>
        </div>
